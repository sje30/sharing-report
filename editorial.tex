...
%% I had to alter the line below a little to get the citations to work - BM
...
(e.g. SPM in neuroimaging).  However, we often write new computer programs to solve specific problems in the course of our research.  As authors, how best can we
...
\item [Documentation] Contrary to popular expectations, you do not
  ...
  figure from a paper. Literate programming methods, where code and narrative text are interwoven in the same document, make documentation semi-automatic and can save a lot of time when preparing code to accompany a publication \cite{schulte2012multi, gentleman2012statistical}. 
...
code sharing a normal part of doing Neuroscience. Other efforts might include: training your 
students and postdocs in sound coding principles so that they are not anxious to share their code, 
...
submitting to and reviewing for journals that support code sharing, critically reviewing  grant proposals
 ...
 others in the discipline that code sharing is a desirable activity that helps move the field forward. 
  ...
  (Possible link to a bigger topic on JB re the "Research Manifesto").
