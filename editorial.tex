...
reproduce your work. This may not in all cases be possible or practical,
but it is expected that you will share key parts of the work,
...
time to run, you may prefer to provide a small ``toy''
...
Software Carpentry \cite{wilson_best_2014} and through neuroinformatics
initiatives, e.g. \url{http://python.g-node.org}.  Furthermore, we should
...
for mentions of code availability, and we should acknowledge efforts
